...
public:
	...
	~BaseComponent(){}
	float *analogPtr; // Pointer to access analogdata
	...
	void getComponentRECT1(RECT &retRect1);
...
protected:
	...
	RECT componentRegion1;	// to be set each time component is drawn
