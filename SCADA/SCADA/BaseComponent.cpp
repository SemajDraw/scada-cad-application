...
void BaseComponent::setAnalog1(float analogVal)
{
	analogPtr = &analogVal;
}
...
void BaseComponent::setComponentRECT1(RECT iCompRECT1)
{
	componentRegion1 = iCompRECT1;
}
...
float BaseComponent::getAnalog1(void) 
{
...
void BaseComponent::getComponentRECT1(RECT &retRect1)
{
	retRect1 = componentRegion1; 
}
